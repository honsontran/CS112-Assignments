...
//The following is a method to print the Nodes while testing
...
//	}
    ...
    throws NoSuchElementException {
    	...
    	//If there is more than one node in the CLL. 
    	else {
	...
	//	}
		if (rear == rear.next) { // list has only one node
		      if (vertex.equals(rear.tree.getRoot())) { // found, delete, leaves empty list
		    	  PartialTree PTY = rear.tree;
		    	  rear = null;
		         return PTY;
		      } 
		   }
		   ...
		   do {
		       if (vertex.equals(curr.tree.getRoot())) {
		    	  
		    	   	PartialTree PTX = curr.tree;
